...
def run():
    ...
    data_cache = {}
    print(f"Downloading data for 50 tickers from {start_date} to {end_date}...")
    ...
    md_content = "# Top 50 加密货币 1H浮盈加仓策略 最优参数研究报告\n\n"
    ...
    md_content += "本报告罗列了当前市场上交易量最活跃的 50 种加密货币在该无脑滚雪球策略下的**最强获利参数组合**与抗打击极限。\n\n"
    md_content += "---\n\n"
    ...
    with open('top50_report.md', 'w', encoding='utf-8') as f:
        f.write(md_content)
        
    print("Done. Saved to top50_report.md")
